...
import VisualizarTiempos from './componentes/VisualizarTiempos';
  ...
  const compareRequests = useCallback(async () => {
    ...
    try {
      ...
      const axiosPromise = axios.get(url).then(res => {
        ...
        localStorage.setItem("axiosTime", (performance.now() - axiosStart).toFixed(2));
        setAxiosTime(localStorage.getItem("axiosTime"));
      ...
      const fetchPromise = fetch(url)
        .then(async res => {
          ...
          localStorage.setItem("fetchTime", (performance.now() - fetchStart).toFixed(2));
    ...
    <div className="App">
      ...
      <div className="App-results">
        <div className="result-section">
          <h2>Resultados con Axios: <VisualizarTiempos Tiempo={axiosTime}/> </h2>
        ...
        <div className="result-section">
          <h2>Resultados con Fetch: <VisualizarTiempos Tiempo={fetchTime}/>
          </h2>
